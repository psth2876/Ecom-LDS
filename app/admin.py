...
class Product_Admin(admin.ModelAdmin):
    ...
    list_display = ('product_name', 'price', 'categories','quantity', 'availability', 'section', 'model_Name')
    list_editable = ('price', 'categories', 'quantity', 'availability', 'section', 'model_Name')
